    ...
    <div class="  justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
                <div class="flex items-center space-x-3 p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <img src="{{ asset('logo.png') }}" class="w-20" alt="">
                    <x-typography.h6>Ethiopian Nuitraion Leaders Network</x-typography.h6>
