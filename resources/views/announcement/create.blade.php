...
@section('content')
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/announcements/create"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Make
                            Announcement</a>
                    </div>
                </li>
    ...
    <div class="py-4">
        ...
        <form method="post" action="/announcements/store" class="">
            @csrf
