...
@section('content')
    <div class="flex justify-between py-4">
        ...
        {{-- create button --}}
        <a href='{{ route('ebook.create') }}' type="button"
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <tbody>
                ...
                @foreach ($ebookList as $item)
                    <tr
                        ...
                        <td class="px-3 py-4">
                            <img src="{{ asset($item->thumbnail) }}" class="w-32" alt="" srcset="">
                        </td>
                        ...
                        <td class="px-3 py-4 ">
                            {{ Str::substr($item->content, 0, 25) }} ...
                        </td>
                        <td class="px-3 py-4">
                            {{ $item->category }}
                        </td>
                        <td class="px-6 py-4  space-x-2 h-full">
                            <a href={{ route('ebook.show', ['ebook' => $item->id]) }}
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you
                                                sure you want to delete {{ $item->title }}?</h3>
                                            <form action={{ route('ebook.destroy', ['ebook' => $item->id]) }}
                                                method="POST">
                                                @csrf
                                                @method('delete')
        ...
        <div class="px-4">
            {{ $ebookList->links('vendor.pagination.tailwind') }}
        </div>
