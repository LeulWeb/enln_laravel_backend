        ...
        <form method="post" action="{{ route('ebook.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid md:grid-cols-2 gap-x-3">
                ...
                <div class="mb-6  max-md:col-span-2">
                    ...
                    <input type="title" id="title" aria-describedby="helper-text-explanation"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="John Doe, Jonatahn Doe" name="author" value="{{ old('author') }}">
                ...
                <div class="col-span-2 mb-6">
                    ...
                    <textarea id="message" rows="4"
                        ...
                        placeholder="Add description about title here" name="content">{{ old('content') }}</textarea>
                    @error('content')
                        <x-typography.error-form>{{ $message }}</x-typography.error-form>
                    @enderror
                </div>
                ...
                <div class="col-span-2 mb-6">
                    ...
                    <div class="flex">
                        ...
                        <input type="text" id="website-admin"
                            ...
                            placeholder="https://youtu.be/q..." name="youtube_link">
