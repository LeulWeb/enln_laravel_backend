...
@section('content')
    <div class="flex justify-between py-4">
        ...
        <a href='{{ route('blog.create') }}' type="button"
            ...
            <iconify-icon icon="fluent:news-16-regular" width="22"></iconify-icon>
            <span>Add Blog</span>
        </a>
    </div>
    ...
    @else
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <tbody>
                    ...
                    @foreach ($blogList as $item)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <img src="{{ asset($item->thumbnail) }}" class="w-40" alt="" srcset="">
                            </td>
                            ...
                            <td class="px-6 py-4">
                                ...
                                @foreach ($tagList as $tag)
                                    <span type="button"
                                        class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-1 m-1 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">{{ $tag }}</span>
                                @endforeach

                            </td>
                            <td class="px-6 py-4">
                                {{-- <a href={{ route('new.show', ['new' => $item->id]) }}
            ...
            <div class="px-4">
                {{ $blogList->links('vendor.pagination.tailwind') }}
            </div>
