...
@section('content')
    <div class="flex justify-between py-4">
        <x-typography.h4>
            <a href="{{ url()->current() }}">News</a>
        </x-typography.h4>


        {{-- create button --}}
        <a href='{{ route('new.create') }}' type="button"
                ...
                <tbody>
                    ...
                    @foreach ($newsList as $item)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                @if ($item->is_top)
                                    <iconify-icon icon="fontisto:toggle-on" width="28"
                                        style="color: green;"></iconify-icon>
                                @else
                                    <iconify-icon icon="material-symbols:toggle-off" width="28"
