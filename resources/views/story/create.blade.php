            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="title" id="title"
                            ...
                            placeholder="Coming Soon" value="{{ old('title') }}" name="title">
                        @error('title')
                    ...
                    <textarea id="message" rows="4"
                        ...
                        placeholder="Write your thoughts here..." name="summary">{{ old('summary') }}</textarea>
                    @error('summary')
                        <x-typography.error-form>{{ $message }}</x-typography.error-form>
                    @enderror
                    ...
                    <div class="flex space-x-6 h-fit items-center mb-6">
                        <div class="flex items-center ">
                            <input id="default-radio-1" type="radio" value="1" name="is_top"
                        ...
                        <div class="flex items-center">
                            <input checked id="default-radio-2" type="radio" value="0" name="is_top"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <input type="text" id="helper-text" aria-describedby="helper-text-explanation"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="nuitration , health" name="reference" value="{{ old('reference') }}">
                ...
                <div>
                    <div class="mb-6 w-full">
                        ...
                        <label for="editor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">News
                            Description</label>
                        <textarea id="editor" name="content" rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Write the News here...">{{ old('content') }}</textarea>
                        @error('content')
                            <x-typography.error-form>{{ $message }}</x-typography.error-form>
                        @enderror
                    </div>
                    ...
                    <input type="text" id="helper-text" aria-describedby="helper-text-explanation"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="nuitration , health" name="tags" value="{{ old('tags') }}">
                    <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        enter list of tags separted by comma(,)
                    </p>
